...
namespace ButikCvatba1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatalogNum,Name,Description,ImageURL,Price,DataUpdate,TypeProductId")] Product product)
        {
            product.DataUpdate = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CatalogNum,Name,Description,ImageURL,Price,DataUpdate,TypeProductId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
